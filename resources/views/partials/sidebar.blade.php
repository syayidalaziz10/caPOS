...
<body class="font-body">
    <div class="flex">
        ...
        <div class="w-1/2 bg-primary">
            <div class="bg-warna-2 h-screen pb-10 rounded-r-3xl flex flex-col items-center overflow-auto scrollbar-hide">
                <input type="text" placeholder="Cari Menu " class="text-white w-8/12 rounded-2xl my-10 py-2.5 bg-primary pl-8 text-secondary text-md">
                <h1 class="text-secondary text-2xl font-semibold mr-80">Daftar Menu</h1>
                {{-- daftar menu --}}
                <button type="text" class="w-8/12 mt-10 shadow rounded-2xl bg-primary p-4 flex ">
                    <div class="rounded-3xl mr-8 w-20 h-20 bg-cover bg-center" style="background-image: url(img/profil.jpg)"></div>
                    <div class="py-3 text-secondary">
                        <h1 class="font-semibold tracking-wider">Es Teh Juara</h1>
                        <p class="font-extralight">Rp. 10000</p>
                    </div>
                </button>
                {{-- daftar menu --}}
                <button type="text" class="w-8/12 mt-10 shadow rounded-2xl bg-primary p-4 flex ">
        ...
        {{-- detail pesanan --}}
        <div class="bg-primary w-1/2 h-screen py-10 px-16 flex flex-col justify-between overflow-auto scrollbar-hide">
            <div>
                <h1 class="text-4xl text-secondary font-semibold tracking-wide mb-10">Detail Pesanan</h1>
                {{-- jumlah pesan --}}
                <div class="bg-warna-2 rounded-3xl flex flex-col items-center mb-10 py-4">
                    <div class="flex justify-around items-center mb-4">
                        <div>
                            <button class="submit px-3 py-px text-secondary font-semibold text-2xl bg-primary rounded-full">-</button>
                        </div>
                        <div class="shadow rounded-2xl bg-primary p-4 flex items-center mx-10">
                            <div class="rounded-3xl mr-8 w-20 h-20 bg-cover bg-center" style="background-image: url(img/profil.jpg)"></div>
                            <div class="text-secondary mr-32">
                                <h1 class="font-semibold tracking-wider">Es Teh Juara</h1>
                                <p class="font-extralight">Rp. 10000</p>
                            </div>
                            <button type="submit">
                        ...
                        <div>
                            <button class="submit px-2.5 py-px text-secondary font-semibold text-2xl bg-primary rounded-full">+</button>
                        </div>
                    </div>
                    <div class="w-8/12 flex items-center justify-between">
                        <div class="text-secondary font-semibold tracking-wide">Jumlah Pesan</div>
                        <div class="bg-primary text-secondary text-3xl py-1 px-10 rounded-xl font-bold">2</div>
                    </div>
                </div>
                <div class="bg-warna-2 rounded-3xl flex flex-col items-center mb-10 py-4">
                    <div class="flex justify-around items-center mb-4">
            ...
            <div class="flex items-center justify-between text-secondary">
                <div>
                    ...
                    <h1 class="text-4xl font-bold text-warna-3 ">Rp. 50.000</h1>
                </div>
                <div>
