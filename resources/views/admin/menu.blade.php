...
<head>
    ...
    <title>caPOS | Manajemen Kasir</title>
</head>
                ...
                <div class="pb-10">
                    <button class="flex flex-col items-center">
                        <svg width="41" height="41" viewBox="0 0 52 52" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M44.6116 47.6663C44.6116 39.2813 36.27 32.4997 26 32.4997C15.73 32.4997 7.38831 39.2813 7.38831 47.6663M26 25.9997C28.8732 25.9997 31.6287 24.8583 33.6603 22.8267C35.6919 20.795 36.8333 18.0395 36.8333 15.1663C36.8333 12.2932 35.6919 9.53766 33.6603 7.50602C31.6287 5.47437 28.8732 4.33301 26 4.33301C23.1268 4.33301 20.3713 5.47437 18.3397 7.50602C16.308 9.53766 15.1666 12.2932 15.1666 15.1663C15.1666 18.0395 16.308 20.795 18.3397 22.8267C20.3713 24.8583 23.1268 25.9997 26 25.9997V25.9997Z" stroke="#354374" stroke-opacity="0.5" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                        <p class="text-sm text-primary m-1">MANAJER</p>
                    </button>
                </div>
                <div class="pb-10">
                    <button class="flex flex-col items-center">
...
{{-- main menu --}}
        <div class="w-screen h-screen overflow-auto">
            <div class="w-full flex justify-center">
                <input type="text" placeholder="Cari Menu" class="text-white w-10/12 rounded-2xl my-12 py-3 px-16 bg-warna-2 text-secondary text-md">
            </div>
                    ...
                    <div class="p-6">
                        ...
                        <div class="p-6 space-y-4">
                            ...
                            <div>
                                ...
                                <input type="text" id="namamenu" class="w-full bg-primary py-2 px-6 rounded-xl text-secondary">
                                
                            </div>
                            <div>
                                <label for="harga" class="block text-secondary text-sm mb-2">Harga</label>
                                <input type="text" id="harga" class="w-full bg-primary py-2 px-6 rounded-xl text-secondary">
                            </div>
                            <div>
                ...
                <div class="relative rounded-xl shadow bg-warna-2">
                    ...
                    <div class="p-6">
                        ...
                        <div class="p-6 space-y-4">
                            ...
                            <div>
                                <label for="username" class="block text-secondary text-sm mb-2">Harga</label>
