    ...
    <div class="flex">
        ...
        <div class="w-screen h-screen overflow-auto">
            <div class="w-full flex justify-center">
                <input type="text" placeholder="Cari User Kasir" class="text-white w-10/12 rounded-2xl my-12 py-3 px-16 bg-warna-2 text-secondary text-md">
            </div>
                ...
                <table class="w-10/12 text-center rounded-xl bg-warna-2 border-separate border-spacing-y-2 border-spacing-x-2 text-secondary">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="bg-primary rounded-xl ">Muahmmad Narenda</td>
                            <td class="bg-primary rounded-xl">narendraaa12</td>
