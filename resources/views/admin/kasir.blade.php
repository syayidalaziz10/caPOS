        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="bg-primary rounded-xl rounded-r-xl">
                    <form method="POST" class="inline" action="{{ route('user.destroy', ['user' => $user->id_user]) }}" onsubmit="return confirm('Delete?')">
                        @csrf
                        @method('DELETE')
                    ...
                    data-idUser="{{$user->id_user}}" data-namaUser="{{$user->nama}}" data-tanggal="{{$user->tanggal_lahir}}" data-alamat="{{$user->alamat}}" data-jenisKelamin="{{$user->jenis_kelamin}}" data-noHp="{{$user->no_hp}}" data-gambar="{{$user->gambar}}">
                        ...
                        <div class="flex justify-center items-center space-x-2">
                            <div class="w-full">
                                ...
                                <label class="block text-secondary mt-2">
                                    <div style="background-image: url('/img/profil.jpg'); " class="bg-primary rounded-xl w-full h-48 flex justify-center items-center relative bg-cover bg-center" >
                                    </div>
                                </label>
                            </div>
                            <div class="w-full">
