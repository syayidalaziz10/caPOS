        ...
        <div class="md:flex w-1/2 py-10 justify-around items-center flex-col">
            <form action="">
                ...
                <div class="flex items-center mb-4">
                    <input type="text" name="username" id="username" placeholder="Username" class="p-3 pl-8 pr-52 rounded-md outline-none border-none bg-secondary" required>
                </div>
                <div class="flex items-center mb-4">
                    <input type="password" name="password" id="password" placeholder="Password" class= "p-3 pl-8 pr-52 rounded-md outline-none border-none bg-secondary" required>
                </div>
